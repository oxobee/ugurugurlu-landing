...
const SEO_META = {
  ...
  ar: {
    ...
    description: 'تميز في أمازون وإيتسي والمزيد مع صور المنتجات الاحترافية بالذكاء الاصطناعي وعروض المانيكان ومقاطع الفيديو الإعلانية. احصل على عرض سعر اليوم!',
